...
const slides = [
  {
    ...
    section: "intro",
    title: "AI AT WORK",
    subtitle: "The teams using AI today are not working the same way anymore.",
    text:
      "This is not a theory session. We will create an AI Agent, build an AI workspace, automate an Excel workflow and publish a live Hub page.",
    beforeAfter: [
